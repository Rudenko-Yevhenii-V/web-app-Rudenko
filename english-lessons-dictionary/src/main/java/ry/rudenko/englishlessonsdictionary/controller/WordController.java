...
public class WordController {
  ...
  public ResponseEntity<WordEntity> AddWord(@RequestBody WordDto wordDto) {
    ...
    return ResponseEntity.ok(Objects.requireNonNullElseGet(wordEntityByWord,
        () -> wordEntityRepository.save(wordEntity)));
  }
  ...
  public ResponseEntity<?> findAllWordsInDictionary() {
    ...
    allByUserEntities.forEach(wordEntity -> wordDtos.add(new WordDto(
